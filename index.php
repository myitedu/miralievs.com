...
<body data-spy="scroll" data-target="#navbar-collapse-toggle" data-offset="70">
    ...
    <main class="main-left">
        ...
        <section id="home" class="home-banner">
                ...
                <div class="row full-screen align-items-center">
                    <div class="col-lg-7">
                        <div class="type-box">
                            ...
                            <h1 class="font-alt">Mirjalol Miraliev</h1>
                            <p class="lead">Full-stack Developer</p>
                            <p class="desc">I'm Mirjalol Miraliev, a seasoned full stack developer with a passion for crafting web applications that bring value to users. covering both frontend and backend development, along with expertise in database management.</p>
                            <div class="btn-bar">
            ...
            <div class="hb-me" style="background-image: url(static/img/myphoto.jpg);"></div>
        </section>
        <!-- End Home -->
        <!-- about us -->
                        ...
                        <div class="about-me">
                            <div class="img">
                                ...
                                <div class="nav social-icons justify-content-center">
                                    ...
                                    <a href="https://instagram.com/miraliev_7?utm_source=qr&igshid=OGU0MmVlOWVjOQ%3D%3D"><i class="fab fa-instagram"></i></a>
                                    <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                            <div class="info">
                                <h3>Mirjalol Miraliev</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7 ml-auto">
                        <div class="about-info">
                            ...
                            <div class="about-text">
                                <p>I am a full stack developer. from New York. I program and create web applications for wonderful people from all over the world. I am open to new learning. I like working with new people. and share your experience.</p>
                            </div>
                            <div class="info-list">
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <ul>
                                            ...
                                            <li>
                                                <label>Email: </label>
                                                <span>mirjalol.miraliev11  gmail.com</span>
                                            </li>
                    ...
                    <div class="col-lg-4 m-15px-tb">
                        <div class="feature-box-01">
                            ...
                            <div class="feature-content">
                                ...
                                <p class="seo">I'm Full Stack Developer, eager to learn and grow in the world of web development. I'm passionate about coding and building things that work. I'm excited to be a part of dynamic teams and contribute to exciting projects.</p>
                            </div>
                        </div>
                    </div>
                   ...
                   <!--  <div class="col-lg-4 m-15px-tb">
                    ...
                    <div class="col-lg-4 m-15px-tb">
                        <div class="feature-box-01">
                            ...
                            <div class="feature-content">
                                <h5>SEO Marketing</h5>
                                <p class="seo">I am an accomplished full-stack developer with a strong proficiency in HTML, CSS, JavaScript, Bootstrap, jQuery, and PHP, enabling me to create dynamic and visually appealing web applications and websites.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 m-15px-tb">
                        <div class="feature-box-02 media align-items-center">
                            <div class="icon">
                                <img src="static/img/350x350.jpg" title="" alt="">
                            </div>
        ...
        <section id="resume" class="section">
            ...
            -->
                ...
                <!-- MY COMMENT    <div class="resume-row">
                        <div class="row">
                            <div class="col-md-4 col-xl-3">
                                <div class="rb-left">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 ml-auto m-15px-tb">
                        <div class="skill-lt">
                            ...
                            <span>81%</span>
                            <div class="skill-bar">
                                <div class="skill-bar-in" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div><!-- /skill -->
                        <div class="skill-lt">
                            <h6>CSS</h6>
                ...
                <div class="portfolio-content grid-gutter-lg grid-col-3 lightbox-gallery">
                    <div class="grid-item product branding fashion">
                        <div class="portfolio-box-01">
                            ...
                            <div class="portfolio-img">
                                <img src="static/img/pepsi3.png" title="" alt="">
                                <div class="portfolio-icon">
                                    <a href="static/img/pepsi3.png" class="gallery-link">
                    ...
                    <div class="grid-item photoshop">
                        <div class="portfolio-box-01">
                            ...
                            <div class="portfolio-img">
                                <img src="static/img/weather.png" title="" alt="">
                                <div class="portfolio-icon">
                                    <a href="static/img/weather.png" class="gallery-link">
                                        <span class="ti-plus"></span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="grid-item product branding">
                        <div class="portfolio-box-01">
                            ...
                            <div class="portfolio-img">
                                <img src="static/img/650x650b.jpg" title="" alt="">
                                <div class="portfolio-icon">
                                    <a href="static/img/650x650b.jpg" class="gallery-link">
                                        <span class="ti-plus"></span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="blog-grid">
                            <div class="blog-img">
                                <a href="single-blog.html">
                                    <img src="static/img/1000x650.jpg" title="" alt="">
                                </a>
                            </div>
                            <div class="blog-info">
                                <div class="meta">29/FEB/2020 - WEBSITE - 1 COMMENT</div>
                                <h6><a href="single-blog.html">Five Solid Evidences Attending Design Is Good For Your Career Development.</a></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 m-15px-tb">
                        <div class="blog-grid">
                            ...
                            <div class="blog-info">
                                <div class="meta">29/FEB/2020 - WEBSITE - 1 COMMENT</div>
                                <h6><a href="single-blog.html">Ten Mind-Blowing Reasons Why Design Is Using This Technique For Exposure.</a></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 m-15px-tb">
                        <div class="blog-grid">
                            ...
                            <div class="blog-info">
                                <div class="meta">29/FEB/2020 - WEBSITE - 1 COMMENT</div>
                                <h6><a href="single-blog.html">I Will Tell You The Truth About Design In The Next 60 Seconds.</a></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 m-15px-tb">
                        <div class="blog-grid">
                            ...
                            <div class="blog-info">
                                <div class="meta">29/FEB/2020 - WEBSITE - 1 COMMENT</div>
                                <h6><a href="single-blog.html">What You Know About Design And What You Don't Know About Design.</a></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 read-more-blog text-center">
                        <a class="px-btn px-btn-white" href="blog.html">More Blogs</a>
                    </div>
                </div>
            </div>
        </section>
